export const projects = [
  {
    image: "src/images/devlore-screenshot.png",
    title: "Beta Tasters",
    description:
  ...
  },
  {
    ...
    title: "Denver Recs",
    description: "A front-end application displaying entertainment recommendations for the Denver, CO area.",
  ...
  },
  {
    ...
    description: "Command-line application to develop a simple SVG logo based on user input.",
    deployed: "https://drive.google.com/file/d/1Q-18GasGf_ipmKLsaW1hNEEN7FZ1sN8B/view?usp=share_link",
  ...
  },
  {
    ...
    description: "Back end application for an e-commerce website using Express.js and MySQL.",
    deployed: "https://drive.google.com/file/d/1_x8vmGbNMsTQKvB5AcGNJQgRE6S_3M1O/view?usp=share_link",
  ...
  },
  {
    ...
    description: "Application that allows the user to add hourly tasks and displays colors coordinated with past, present and future times.",
